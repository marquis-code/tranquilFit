            ...
            <div
                ...
                <div
                    ...
                    <div class="lg:row-start-2 lg:max-w-md">
                        <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl" data-aos="zoom-in">Boost
                            your productivity.<br>Start using our app today.</h2>
                        <p class="mt-6 text-lg leading-8 text-gray-300" data-aos="zoom-in">Ac euismod vel sit maecenas
                            id pellentesque eu sed consectetur. Malesuada adipiscing sagittis vel nulla. Ac euismod vel
                            sit maecenas.</p>
                    </div>
                    <img data-aos="zoom-in"
                        src="@/assets/img/exercise8.jpg"
                    ...
                    <div class="max-w-xl lg:row-start-3 lg:mt-10 lg:max-w-md lg:border-t lg:border-white/10 lg:pt-10">
                        <dl class="max-w-xl space-y-8 text-base leading-7 text-gray-300 lg:max-w-none">
                            <div class="relative" data-aos="zoom-in">
                                ...
                                <dd class="inline" data-aos="zoom-in">Lorem ipsum, dolor sit amet consectetur
                                    adipisicing elit aute id magna.</dd>
                            </div>
                            <div class="relative" data-aos="zoom-in">
                                <dt class="ml-9 inline-block font-semibold text-white">
                                    <svg class="absolute left-1 top-1 h-5 w-5 text-indigo-500" viewBox="0 0 20 20"
                                ...
                                <dd class="inline" data-aos="zoom-in">Anim aute id magna aliqua ad ad non deserunt
                            ...
                            <div class="relative" data-aos="zoom-in">
                                ...
                                <dd class="inline" data-aos="zoom-in">Ac tincidunt sapien vehicula erat auctor
                                    pellentesque rhoncus.</dd>
                            </div>
                        </dl>
                    </div>
                </div>
