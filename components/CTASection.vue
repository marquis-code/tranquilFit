    ...
    <div class="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
      <div
        ...
        <div class="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
          <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Start Your Weight Loss Journey</h2>
          <p class="mt-6 text-xl leading-8 text-gray-600">Join our stress-free weight loss program and achieve your goals.</p>
          <!-- <p class="mt-6 text-base leading-7 text-gray-600">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure
            qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat. Quasi aperiam sit non sit neque
            reprehenderit.</p> -->
