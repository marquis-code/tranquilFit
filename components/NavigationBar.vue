        ...
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <div class="relative">
                    ...
                    <div v-if="isProductModalOpen" ref="productRef"
              ...
              -->
                    <div v-if="isCompanyModalOpen" ref="companyRef"
                        ...
                        <div class="relative rounded-lg p-4 hover:bg-gray-50">
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-600">Get in touch with our dedicated support team
                                or reach out on our community forums</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <a href="#" @click.prevent="router.push({ path: '/auth', query: { type: 'login' } })"
