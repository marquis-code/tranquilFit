...
-->
    <div class="relative bg-white py-16">
        ...
        <div class="mx-auto max-w-7xl bg-indigo-600 lg:bg-transparent lg:px-8">
            <div class="lg:grid lg:grid-cols-12" data-aos="zoom-out-right">
                <div class="relative z-10 lg:col-span-4 lg:col-start-1 lg:row-start-1 lg:bg-transparent lg:py-16">
                    ...
                    <div class="mx-auto max-w-md px-6 sm:max-w-3xl lg:max-w-none lg:p-0">
                        <div class="aspect-h-6 aspect-w-10 sm:aspect-h-1 sm:aspect-w-2 lg:aspect-w-1">
                            <img class="rounded-3xl object-cover object-center shadow-2xl" data-aos="zoom-out-right"
                                src="@/assets/img/exercise7.jpg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <h2 class="text-3xl font-bold tracking-tight text-white" id="join-heading"
                            data-aos="zoom-out-right">Join our team</h2>
                        <p class="text-lg text-white" data-aos="zoom-out-right">Varius facilisi mauris sed sit. Non sed
                            et duis dui leo, vulputate id malesuada non. Cras aliquet purus dui laoreet diam sed lacus,
                            fames.</p>
