<template>
    <main class="py-6">
        <div class="lg:flex lg:h-full lg:flex-col px-6 lg:px-0 container mx-auto">
                ...
                <div class="flex items-center">
                    <div class="relative flex items-center rounded-md bg-white shadow-sm md:items-stretch">
                        <button type="button"
                            ...
                            <span class="sr-only" data-aos="zoom-out-right">Previous month</span>
                        ...
                        <button type="button"
                            ...
                            <span class="sr-only" data-aos="zoom-out-right">Next month</span>
                            <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                <path fill-rule="evenodd"
                    ...
                    <div class="hidden md:ml-4 md:flex md:items-center">
                        <div class="relative">
                            <button type="button" @click="showViewTypes = !showViewTypes"
            ...
            <div class="shadow ring-1 ring-black ring-opacity-5 lg:flex lg:flex-auto lg:flex-col" data-aos="zoom-out-right">
                <div
                    class="grid grid-cols-7 gap-px border-b border-gray-300 bg-gray-200 text-center text-xs font-semibold leading-6 text-gray-700 lg:flex-none">
                    <div class="flex justify-center bg-white py-2" data-aos="zoom-out-right">
                        <span>M</span>
              ...
              -->
                ...
                -->
                        ...
                        <div class="relative bg-gray-50 px-3 py-2 text-gray-500" data-aos="zoom-out-right">
                        ...
                        <div class="relative bg-white px-3 py-2" data-aos="zoom-out-right">
                    ...
                    <div class="isolate grid w-full grid-cols-7 grid-rows-6 gap-px lg:hidden" data-aos="zoom-out-right">
                        <!--
              ...
              -->
                        <button type="button" data-aos="zoom-out-right"
            ...
            <div class="px-4 py-10 sm:px-6 lg:hidden">
                <ol
                    ...
                    <li class="group flex p-4 pr-6 focus-within:bg-gray-50 hover:bg-gray-50" data-aos="zoom-out-right">
                        <div class="flex-auto">
