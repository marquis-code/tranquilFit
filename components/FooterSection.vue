    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          ...
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              ...
              <ul role="list" class="mt-6 space-y-4">
                <li>
                  <a href="#" class="text-sm leading-6 text-gray-300 hover:text-white">Weight Loss</a>
                </li>
                <li>
                  <a href="#" class="text-sm leading-6 text-gray-300 hover:text-white">Fitness</a>
                </li>
                <li>
                  <a href="#" class="text-sm leading-6 text-gray-300 hover:text-white">Nutrition</a>
                </li>
                <li>
                  <a href="#" class="text-sm leading-6 text-gray-300 hover:text-white">Coaching</a>
                </li>
                <li>
            ...
            <div class="mt-10 md:mt-0">
              ...
              <ul role="list" class="mt-6 space-y-4">
                ...
                <li>
                  <a href="#" class="text-sm leading-6 text-gray-300 hover:text-white">FAQ</a>
                </li>
                <li>
      ...
      <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
        <div>
          ...
          <p class="mt-2 text-sm leading-6 text-gray-300">Stay up to date on the latest features and releases by joining
            our newsletter.</p>
        </div>
      ...
      <div class="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
        ...
        <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">&copy; 2024 Stress-Free Weight Loss. All
          rights reserved.</p>
      </div>
    </div>
  </footer>
