    ...
    <div class="flow-root">
          ...
          <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-br-lg rounded-bl-lg">
            <table class="min-w-full divide-y divide-gray-300">
              <thead class="bg-gray-50">
                <tr>
                  <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Avatar</th>
                  ...
                  <th v-if="userRole !== 'ROLE_USER'" scope="col" class="relative py-3.5 pl-3 pr-4 sm:pr-6">
      ...
      'Delete' }}<span class="sr-only">
                      ...
                      <nuxt-link :to="`/dashboard/organization/${itm.id}/members`"
                        class="text-white px-6 py-2 rounded-md bg-black text-sm">View Members</nuxt-link>
                    </div>
                  </td>
                </tr>
              </tbody>
