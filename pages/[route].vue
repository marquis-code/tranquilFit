    ...
    <NuxtLayout>
        <main class="relative isolate min-h-full">
            ...
            <div class="mx-auto max-w-7xl px-6 py-32 text-center sm:py-40 lg:px-8">
                ...
                <p class="mt-4 text-base text-white/70 sm:mt-6">Sorry, we couldn’t find the page you’re looking for. {{
                    error.message }}</p>
                <div class="mt-10 flex justify-center">
                    <a @click="handleError" href.prevent="#" class="text-sm font-semibold leading-7 text-white"><span
