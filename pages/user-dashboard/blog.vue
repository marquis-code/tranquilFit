  ...
  <div class="bg-white">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:max-w-4xl">
        <div class="mt-16 space-y-20 lg:mt-2 lg:space-y-20 overflow-y-auto h-[650px] hide-scrollbar">
          <article v-for="item in posts" :key="item" class="relative isolate flex flex-col gap-8 lg:flex-row">
