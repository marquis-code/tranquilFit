              ...
              <ul role="list" class="-mx-2 space-y-1">
                <li>
                  ...
                  <NuxtLink to="/dashboard/organization" 
                    class="bg-gray-800 text-white group flex gap-x-3 rounded-md p-2.5 text-sm leading-6 font-semibold">
                ...
                <li>
                  <NuxtLink to="/dashboard/workflow" 
                    class="text-gray-600 hover:text-gray-800 hover:bg-white group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                    <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                      stroke="currentColor" aria-hidden="true">
                      <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <li>
                  <NuxtLink to="/team" 
                    class="text-gray-400 hover:text-gray-800 hover:bg-white group flex gap-x-3 rounded-md p-2.5 text-sm leading-6 font-semibold">
                    <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                      stroke="currentColor" aria-hidden="true">
                      <path stroke-linecap="round" stroke-linejoin="round"
