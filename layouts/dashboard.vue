          ...
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            <li>
              <ul role="list" class="-mx-2 space-y-1">
                ...
                <li>
                  <a href="#"
                    class="text-gray-600 hover:text-white hover:bg-white group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                    <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                      stroke="currentColor" aria-hidden="true">
                      <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <li>
                  <a href="#"
                    class="text-gray-400 hover:text-white hover:bg-white group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                    <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                      stroke="currentColor" aria-hidden="true">
                      <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="mt-auto">
              <nuxt-link to="/dashboard/organization/create"
                class="group -mx-2 flex justify-center items-center gap-x-3 rounded-md p-2 text-sm font-semibold bg-[#1F9D00] leading-6 text-white hover:bg-gray-800 hover:text-white">
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7 1.375V12.625M12.625 7H1.375" stroke="white" stroke-width="1.2" stroke-linecap="round"
                    stroke-linejoin="round" />
                </svg>
